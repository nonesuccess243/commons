...
public class CrudGenerator
{
         ...
         * 是否生成文件
         */
        public static boolean GENERATE_FILE = true;

        /**
         * 生成后是否建表
         */
        public static boolean CREATE_TABLE = false;

        private final static Logger log = LoggerFactory
                        .getLogger(CrudGenerator.class);
        ...
        {
                this.mapperXmlContent = generateResourceFile("Mapper.xml.ftl",
                                GeneratorFileUtils.INSTANCE
                                                .getMapperXmlFileName(meta));
        }

        private void generateMapperJava() throws Exception
        {
                this.mapperJavaContent = generateAFile("Mapper.java.ftl",
                                GeneratorFileUtils.INSTANCE
                                                .getMapperJavaFileName(meta));
        }

        private void generateExampleJava() throws Exception
        {
                this.exampleJavaContent = generateAFile("Example.java.ftl",
                                GeneratorFileUtils.INSTANCE
                                                .getExampleJavaFileName(meta));
        }

        private void generateCreateSql() throws Exception
        {
                this.createSqlContent = generateSqlFile("create.sql.ftl",
                                meta.getDbTypeName() + ".sql");
        }

        private void generateExtra() throws Exception
        {
                this.extraContent = generateResourceFile("extra.ftl",
                                meta.getModelClass().getSimpleName()
                                                + ".extra");
        }
         ...
         * @throws Exception
         */
        private String generateFile(String templateName, String fileName,
        ...
        private String generateContent(String templateName, String fileName)
                        throws Exception
        {

                Template temp = mapperCfg
                                .getTemplate(db.getFtlFileName(templateName));
         ...
         * @throws Exception
         */
        private String generateAFile(String templatename, String fileName)
                        throws Exception
        {
         ...
         * @throws Exception
         */
        private String generateResourceFile(String templatename,
                        String fileName) throws Exception
        {
                return generateFile(templatename, fileName, resourceDir);
        }

        private String generateSqlFile(String templatename, String fileName)
                        throws Exception
        {
